    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          {/* USER INFO CARD */}
          <div className="bg-colorPurpleLight py-6 px-4 rounded-md flex-1 flex gap-4">
            <div className="w-1/3">
              <Image
                src="https://images.pexels.com/photos/4342401/pexels-photo-4342401.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt=""
                width={144}
                height={144}
            ...
            <div className="flex items-center gap-4">
              <h1 className="text-xl font-semibold">Wendell Melo</h1>
              <FormModal 
              table="teacher" 
              type="update" 
              data={{
                id: 1,
                username: "wendellmelo",
                email: "deanguerrero@gmail.com",
                password: "password",
                firstName: "Wendell",
                lastName: "Melo",
                phone: "+55 79 12444 5988",
                address: "1234 st",
                bloodType: "O-",
